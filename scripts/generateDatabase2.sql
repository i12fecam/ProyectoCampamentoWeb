...
--
ALTER TABLE `Monitores`
  MODIFY `id_monitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `Campamentos`
  ADD CONSTRAINT `Campamentos_ibfk_1` FOREIGN KEY (`id_campamento`) REFERENCES `Inscripciones` (`fk_campamento`) ON UPDATE CASCADE;
